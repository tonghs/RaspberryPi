...
def getCPULoadRate():
    ...
    total_1 = data_1[0] + data_1[1] + data_1[2] + data_1[3] + data_1[
        4] + data_1[5] + data_1[6] + data_1[7] + data_1[8] + data_1[9]
    idle_1 = data_1[3]
    ...
    total_2 = data_2[0] + data_2[1] + data_2[2] + data_2[3] + data_2[
        4] + data_2[5] + data_2[6] + data_2[7] + data_2[8] + data_2[9]
    idle_2 = data_2[3]
...
def setOLEDshow():
    ...
    draw.text((x, top + 24), "wlan0:" + str(IP.decode('utf-8')), font=font, fill=255)
